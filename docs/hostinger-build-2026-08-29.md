...
- **حجم الأرشيف:** `38,185,904` بايت
- **SHA-256 للأرشيف:** `1e7bad7028f3f5e3e3a31ad427ab022689b0c1bafe80d31c83cf6129ed3bca3c`
...
- **227** ملف HTML إجماليًا.
- **151** صفحة قابلة للفهرسة و**76** صفحة توافق `noindex`.
- **151** رابطًا فريدًا في Sitemap.
- **151/151** canonical للصفحات المفهرسة، مع تطابق **151/151** مع Sitemap.
- **151/151** صفحة مفهرسة لديها Meta Description.
- **151/151** وصفًا ضمن نطاق الجودة `120–160` حرفًا.
- **151/151** صفحة مفهرسة لديها JSON-LD صالح.
- **151/151** صفحة مفهرسة تحتوي روابط داخلية قابلة للفحص.
- **206** صورة في Sitemap و**167** صورة مستخدمة في HTML، وجميعها موجودة داخل الأرشيف.
