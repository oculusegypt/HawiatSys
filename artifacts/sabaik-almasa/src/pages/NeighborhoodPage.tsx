...
const SERVICE_LINK_SLUGS: Record<string, string> = {
  "تنظيف فلل وقصور بالرياض": "تنظيف-فلل-وقصور-بالرياض",
  "تنظيف بعد البناء والتشطيب": "تنظيف-بعد-البناء-والتشطيب-بالرياض",
  "تنظيف شقق بالرياض": "تنظيف-شقق-بالرياض",
  "تنظيف واجهات مباني بالرياض": "تنظيف-واجهات-مباني-بالرياض",
  "تنظيف وتطهير خزانات بالرياض": "تنظيف-وتطهير-خزانات-بالرياض",
  "تنظيف وغسيل مكيفات بالرياض": "تنظيف-وغسيل-مكيفات-بالرياض",
  "جلي وتلميع رخام بالرياض": "جلي-وتلميع-رخام-بالرياض",
  "غسيل مجالس بالبخار بالرياض": "غسيل-مجالس-بالبخار-بالرياض",
  "مكافحة حشرات بالرياض": "مكافحة-حشرات-بالرياض",
}

function friendlyServiceLink(name: string): string {
  return `/services/${entitySlug({ slug: SERVICE_LINK_SLUGS[name] || name, title: name, fallback: "service" })}`
}
...
export const AREAS: Record<string, AreaData> = {
  "north-riyadh": {
    ...
    primaryServices: [
      { name: "تنظيف فلل وقصور بالرياض", link: friendlyServiceLink("تنظيف فلل وقصور بالرياض"), desc: "تنظيف شامل وعميق للأدوار والمسابح والواجهات." },
      { name: "تنظيف بعد البناء والتشطيب", link: friendlyServiceLink("تنظيف بعد البناء والتشطيب"), desc: "إزالة بقايا الدهان والإسمنت والجبس وتسليم المفتاح." },
      { name: "جلي وتلميع الرخام بالألماس", link: friendlyServiceLink("جلي وتلميع رخام بالرياض"), desc: "إعادة البريق الزجاجي للأرضيات والمداخل بالكريستال الإيطالي." },
    ],
    faqs: [
  ...
  "al-malqa": {
    ...
    primaryServices: [
      { name: "تنظيف الفلل والقصور", link: friendlyServiceLink("تنظيف فلل وقصور بالرياض"), desc: "غسيل الواجهات الزجاجية والمسابح والأحواش." },
  ...
  "south-riyadh": {
    ...
    arrivalTime: "35 دقيقة",
    primaryServices: [
      { name: "تنظيف المنازل والخزانات", link: friendlyServiceLink("تنظيف وتطهير خزانات بالرياض"), desc: "غسيل شامل للخزانات وتعقيم المياه من الرواسب." },
      { name: "مكافحة الآفات ورش المبيدات", link: friendlyServiceLink("مكافحة حشرات بالرياض"), desc: "إبادة تامة للصراصير والنمل الأبيض وبق الفراش مع الضمان." },
    ],
    faqs: [
...
function makeAreaFallback(name: string, region: string, relatedAreas: string[] = []): AreaData {
  ...
  return {
    ...
    arrivalTime: "30 — 45 دقيقة",
    primaryServices: [
      { name: "تنظيف الفلل والمنازل", link: friendlyServiceLink("تنظيف فلل وقصور بالرياض"), desc: "تنظيف عميق وشامل للأدوار والمطابخ والواجهات." },
      { name: "غسيل المجالس بالبخار", link: friendlyServiceLink("غسيل مجالس بالبخار بالرياض"), desc: "تعقيم فوري وإزالة البقع بأحدث أجهزة البخار الحار." },
      { name: "تنظيف الخزانات والمكيفات", link: friendlyServiceLink("تنظيف وتطهير خزانات بالرياض"), desc: "غسيل وتطهير الخزانات بالكلور وغسيل المكيفات بجراب الحماية." },
    ],
    faqs: [
