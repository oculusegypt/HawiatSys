...
const ALL_NAV = [
  ...
  { href: "/admin/packages",          icon: Box,             label: "أنواع الحاويات",         group: "operations",    section: "packages" },
  { href: "/admin/ads",               icon: Megaphone,       label: "العروض الموسمية",       group: "operations",    section: "ads" },
  ...
  { href: "/admin/analytics",         icon: BarChart3,       label: "التقارير والتحليلات",    group: "analytics",     section: "analytics" },
  { href: "/admin/blog",              icon: BookOpen,        label: "المدونة",               group: "analytics",     section: "blog" },
  { href: "/admin/seo-pages",         icon: FilePenLine,     label: "الصفحات",               group: "analytics",     section: "seo_pages" },
  { href: "/admin/seo",               icon: Search,          label: "SEO",                   group: "analytics",     section: "seo" },
  { href: "/admin/reviews",           icon: Star,            label: "تقييمات الخدمات",       group: "extra",         section: "reviews" },
  { href: "/admin/settings",          icon: SlidersHorizontal, label: "الإعدادات",          group: "extra",         section: "settings" },
  { href: "/admin/employees",         icon: Users,           label: "الموظفون",              group: "site_settings", section: "employees" },
  { href: "/admin/roles-permissions", icon: KeyRound,        label: "الأدوار والصلاحيات",    group: "site_settings", section: "employees" },
  { href: "/admin/database",          icon: Database,        label: "قاعدة البيانات",        group: "site_settings", section: "database" },
]
