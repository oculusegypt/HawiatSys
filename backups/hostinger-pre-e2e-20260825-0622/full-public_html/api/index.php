...
try {
    ...
    function generateToken(int $adminId): string {
        $tokenSecret = getenv('SESSION_SECRET') ?: '3d976a6ae9ab4e0878220d0bda4f382a5abf67e6c02d5ce6735d1cf88cc8d78a';
    ...
    function hostingerPatchKey(): string {
        $secret = getenv('SESSION_SECRET') ?: '3d976a6ae9ab4e0878220d0bda4f382a5abf67e6c02d5ce6735d1cf88cc8d78a';
