...
const containers: Array<[string, 12 | 20, string, string, string]> = [
  ["CNT-12-01", 12, "available", "مستودع الرياض", "نظيفة وجاهزة"],
  ["CNT-12-02", 12, "available", "مستودع الرياض", "نظيفة وجاهزة"],
  ["CNT-12-03", 12, "rented", "مشروع الياسمين", "مؤجرة لعقد تجريبي"],
  ["CNT-12-04", 12, "available", "مستودع الشمال", "تم الفحص"],
  ["CNT-12-05", 12, "maintenance", "ورشة الرياض", "تحتاج فحص أبواب"],
  ["CNT-12-06", 12, "available", "مستودع الرياض", "نظيفة وجاهزة"],
  ["CNT-12-07", 12, "busy", "في مهمة ميدانية", "مع السائق يوسف القحطاني"],
  ["CNT-12-08", 12, "available", "مستودع الشمال", "جاهزة للتخصيص"],
  ["CNT-12-09", 12, "available", "مستودع الرياض", "تم الفحص"],
  ["CNT-12-10", 12, "rented", "حي النرجس", "مؤجرة لعقد تجريبي"],
  ["CNT-20-01", 20, "available", "مستودع الرياض", "نظيفة وجاهزة"],
  ["CNT-20-02", 20, "available", "مستودع الرياض", "تم الفحص"],
  ["CNT-20-03", 20, "rented", "مشروع الملقا", "مؤجرة لعقد تجريبي"],
  ["CNT-20-04", 20, "available", "مستودع الجنوب", "جاهزة للتخصيص"],
  ["CNT-20-05", 20, "maintenance", "ورشة الرياض", "تحتاج دهاناً خارجياً"],
  ["CNT-20-06", 20, "available", "مستودع الرياض", "نظيفة وجاهزة"],
  ["CNT-20-07", 20, "busy", "في مهمة ميدانية", "مع السائق خالد الحربي"],
  ["CNT-20-08", 20, "available", "مستودع الجنوب", "تم الفحص"],
  ["CNT-20-09", 20, "available", "مستودع الرياض", "جاهزة للتخصيص"],
  ["CNT-20-10", 20, "rented", "حي الصحافة", "مؤجرة لعقد تجريبي"],
];
