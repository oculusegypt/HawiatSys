...
export const homepageContent = {
  ...
  sections: {
    ...
    contact: {
      ...
      whatsappText: "تواصل عبر واتساب (0580595555)",
      callText: "اتصال هاتفي مباشر (0555888767)",
    },
  },
};

const settings = [
  ["site_desc", "مؤسسة تقي جروب — الرائدون في تأجير حاويات المخلفات ونقل الأنقاض بالرياض. حاويات بمقاسات متعددة وسرعة في الأداء ودقة في المواعيد. اتصل الآن: 0555888767"],
