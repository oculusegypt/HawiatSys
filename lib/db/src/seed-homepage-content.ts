...
const settings = [
  ["site_desc", "مؤسسة تقي جروب — الرائدون في تأجير حاويات المخلفات ونقل الأنقاض بالرياض. حاويات بمقاسات متعددة وسرعة في الأداء ودقة في المواعيد. اتصل الآن: 0558606020"],
