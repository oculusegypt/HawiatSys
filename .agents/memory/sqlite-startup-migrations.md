...
**How to apply:** Add the Drizzle table for types and queries, then add idempotent startup DDL and indexes in the database client initialization. Keep the column names and defaults synchronized.